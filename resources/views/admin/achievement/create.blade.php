...
@section('content')
            ...
            <div class="col-lg-12 text-left">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{ isset($item) ? 'Edit Achievement' : 'Add New Achievement' }}</li>
                </ol>
              </nav>
            </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <form action="{{ isset($item) ? route('achievements.update', $item->id) : route('achievements.store')  }}" method="post" enctype="multipart/form-data">
        @csrf
          ...
          <div class="row">
              <div class="col-xl-8">
                  <div class="card card-defualt">
                      ...
                      <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-9 mb-2 text-left">
                            ...
                            <div class="form-group col-md-3 mb-2 text-left">
                                <label class="font-weight-bold text-uppercase">Number</label>
                                <input type="number" min="1" name="number" class="@error('number') is-invalid @enderror form-control" placeholder="Number" value="{{ isset($item) ? $item->number : old('number') }}" required>
                                @error('number')
                                    <div>
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
