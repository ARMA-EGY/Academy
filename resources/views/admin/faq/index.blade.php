        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('faq.create')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> New FAQ</a>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">FAQs List  <span class="badge badge-primary p-2">{{$items->count()}}</span></h3>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  <tr class="parent">
                    ...
                    <td>
                      ...
                      <span class="btn btn-sm btn-danger remove_item" data-id="{{$item->id}}" data-url="{{route('faq.remove')}}"><i class="fa fa-trash-alt"></i> Remove</span>
                    </td>
                  </tr>
